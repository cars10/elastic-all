...
start:
	docker compose up -d es-9-node-1 es-9-node-2 es-8-node-1 es-8-node-2 es-8-node-3 es-7-node-1 es-7-node-2 es-6-node-1 es-6-node-2 es-5-node-1 es-2-node-1 es-1-node-1
...
8:
	docker compose up -d es-8-node-1 es-8-node-2 es-8-node-3
